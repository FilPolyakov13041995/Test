<template>
  <header
    class="header flex items-center justify-between h-19 bg-gradient-to-l from-white to-slate-50"
  >
    <div class="flex items-center gap-7">
      <div class="flex flex-col gap-1">
        <div class="border border-blue-custom w-4 rounded-lg"></div>
        <div class="border border-blue-custom w-4 rounded-lg"></div>
        <div class="border border-blue-custom w-4 rounded-lg"></div>
      </div>
      <h1 class="text-1xl text-blue-custom">Team</h1>
    </div>
    <div class="flex items-center gap-7">
      <SearchVue />
      <NotificationsVue />
      ...
      <div class="flex items-center gap-3">
        ...
        <h3 class="text-blue-custom text-sm">Ernest Eberly</h3>
        <ArrowDownVue /> 
      </div>
    </div>
  </header>
